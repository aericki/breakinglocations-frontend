      ...
      <div className="w-full md:w-1/2 flex flex-col h-full p-4 sm:p-6 md:p-8 lg:p-12 overflow-y-auto">
        ...
        <div className="w-full mt-4 sm:mt-6 pt-2 sm:pt-4 border-t border-gray-200">
          <div className="flex justify-center space-x-4 mb-2">
            <a href="https://github.com/aericki" target="_blank" className="text-gray-600 hover:text-blue-600" aria-label="GitHub">
            ...
            <a href="https://www.linkedin/aericki" className="text-gray-600 hover:text-blue-600" target="_blank" aria-label="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
